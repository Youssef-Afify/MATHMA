...
<body>
    ...
    if (isset($_POST['added'])) {
        ...
        $insertquery = "INSERT INTO `books` (book_name,book_price,book_desc,book_image,book_sample,book_temp) VALUES('$bookname','$bookprice','$bookdesc','$imgfilename','$pdffilename','$pdftempname')";
