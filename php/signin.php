...
<head>
    ...
    <link rel="stylesheet" href="../css/mysignin.css">
...
<body>
    <nav class="navbar navbar-expand-lg sticky-top nav1" id="nav1">
        <div class="container">
    ...
    <div class="container my-3 page1">
        <div class="container">
            <h1 class="dm-serif-text-regular-italic desc"><br>Sign In</h1>
            <br><br>
            <form action="connection.php" method="post">
                ...
                <div>
                    <input class="mb-4 w-100 dm-serif-text-regular-italic" id="mysub" type="submit" name="logged"
                        value="Sign In">
                </div>
            </form>
        </div>
