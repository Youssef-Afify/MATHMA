...
<body>
    ...
    <div class="container my-3">
        <div class="container">
            <h1 class="dm-serif-text-regular-italic desc"><br>Update your information</h1>
        </div>
        <br><br>
        ...
        if (isset($_POST["updated"])) {
            ...
            if ($password === $password2) {
                ...
                $updatequery = "UPDATE admins SET `admin_name` = '$username', `admin_email` = '$email', `admin_password` = '$hashedpass' WHERE `admin_id` = '$adminid'";
        ...
        <form action="" method="post">
            ...
            <div class="form-floating my-4">
                <input type="email" class="form-control" id="floatingInput" name="email" required
                    placeholder="name@example.com" value="<?php echo $_SESSION['admin_email']; ?>">
            ...
            <div>
                <input class="my-4 w-100 dm-serif-text-regular-italic" id="mysub" type="submit" name="updated"
                    value="Update">
            </div>
        </form>
    </div>
