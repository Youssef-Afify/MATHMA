...
<body>
    ...
    <div class="container my-3">
        <div class="container">
            <h1 class="dm-serif-text-regular-italic desc" style="text-align: center;"><br>Admin's Page</h1>
            <br><br>
            <div class="row row-cols-1 row-cols-md-3 g-4">
                <div class="col">
                    <div class="card text-center h-100">
                        <a class="links2" href="create.php">
                            <img src="../images/Plus_symbol.png" class="card-img-top" alt="...">
                            <div class="card-body">
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<div class='col'>
                        <div class='card h-100'>
                            <a class='links2' href='admin_details.php?bid=" . $row['book_id'] . "'>
                                ...
                                <div class='card-footer'>
                                    <small class='text-body-secondary'>" . $row["book_price"] . ' $' . "</small>
                                </div>
                            </a>    
                        </div>
                    </div>";
