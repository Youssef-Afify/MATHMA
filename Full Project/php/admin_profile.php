        ...
        <div class="container">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="" class="list-group-item list-group-item-action disabled">Email:
                    <?php echo $_SESSION['admin_email']; ?></a>
                    <a href="" class="list-group-item list-group-item-action disabled">Type: Admin</a>    
                <a href="create.php" class="list-group-item list-group-item-action list-group-item-success">Create
                    a new book</a>
                <a href="admin_confirm.php?adminid=<?php echo $_SESSION['admin_id']; ?>"
                    class="list-group-item list-group-item-action list-group-item-info">Edit your information</a>
                <a href="disconnect.php" class="list-group-item list-group-item-action list-group-item-danger">Sign Out</a>
            </div>
        </div>
    </div>
</body>
