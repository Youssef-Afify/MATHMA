...
<body>
    ...
    if (isset($_POST['updated'])) {
        ...
        $updatequery = "UPDATE `books` SET `book_name` = '$bookname', `book_price` = '$bookprice', `book_category` = '$bookcategory' , `book_desc` = '$bookdesc', `book_image` = '$imgfilename', `book_sample` = '$pdffilename', `book_temp` = '$pdftempname' WHERE `book_id` = $bookid";
