...
<body>
    ...
    <div class="container my-3">
        <div class="container">
            <h1 class="dm-serif-text-regular-italic desc" style=""><br>Shopping Cart 🛒</h1>
            <br><br>
            <div class="container">
                <div class="row">
                            ...
                            while ($row = $result->fetch_assoc()) {
                                if ($row['added']) {
                                    ...
                                    echo "<li class='list-group-item d-flex justify-content-between align-items-center listed' style='flex-direction: row;'>
                                                <a class='links1' href='details.php?bid=$bookid' style='color: black;'>
                    ...
                    <div class="col-4 mb-4">
                        <form action="buy.php?userid=<?php echo $_SESSION['id']; ?>" method="post">
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    if ($row['added']) {
                                        ...
                                        echo "<input class='list-group-item d-flex justify-content-between align-items-center listed' type='number' 
                                            id='quantity$bookid' name='quantity$bookid' required value=1>
                            ...
                            <input class="my-4 w-100 dm-serif-text-regular-italic" id="bought" type="submit"
                                name="readytobuy" value="Buy Now">
                        </form>
                    </div>
                </div>
                <style>
