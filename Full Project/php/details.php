<!-- Book's info in the user's page -->
<?php
...
$cart = "SELECT * FROM `shoppingcart` WHERE `book_id` = '$bookid' AND `id` = '$userid'";
$cartresult = $con->query($cart);
            ...
            <div class="row">
                <div class="col col-md-8 col-sm-12 bookdesc desc" style="border: 0px solid black; text-align: center;">
                    ...
                    <a class="btn btn-success my-3 mx-5 button1 links1"
                        href="download.php?bid=<?php echo $row['book_id'] ?>" role="button">Download a free sample</a>
                </div>
