        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item p-lg-3">
                        <a href="profile.php?adminid=<?php echo $_SESSION['id']; ?>" id="profile">
    ...
    <div class="container my-3">
        ...
        if (isset($_POST["updated"])) {
            ...
            if ($password === $password2) {
                ...
                $id=$_SESSION['id'];
                $updatequery = "UPDATE users SET `username` = '$username', `email` = '$email', `password` = '$hashedpass', `phonenumber` = '$phonenumber' WHERE `id` = '$id'";
