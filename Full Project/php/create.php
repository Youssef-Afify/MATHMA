...
<body>
    ...
    <nav class="navbar navbar-expand-lg sticky-top" id="nav1">
        <div class="container">
            <a class="navbar-brand" href="#startpage1">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item p-lg-3">
                        <button class="nav-link" id="profile"><a class="links2" href="profile.php">Profile</a></button>
                    </li>
    ...
    if (isset($_POST['added'])) {
        ...
        $insertquery = "INSERT INTO `books` (book_name,book_price,book_category,book_desc,book_image,book_sample,book_temp) VALUES('$bookname','$bookprice','$bookcategory','$bookdesc','$imgfilename','$pdffilename','$pdftempname')";
        $iquery = mysqli_query($con, $insertquery);
        echo "<div class='mx-auto w-50 alert alert-success alert1 dm-serif-text-regular-italic my-4' role='alert'>" . "Added Successfully!" . "</div>";
        style();
    ...
    <div class="container my-3">
        ...
        <h1 class="dm-serif-text-regular-italic desc"><br>Create a new book</h1>
        <br><br>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-floating my-4">
                <select class="form-select" id="floatingCategory" name="bookcategory" required>
                    <option value="" disabled selected>Select a category</option>
                    <?php
                    $result = $con->query("SELECT category_id, book_category FROM categories ORDER BY book_category ASC");
            ...
            <div class="my-4">
                ...
                <textarea class="form-control" id="exampleFormControlTextarea1" name="bookdesc" rows="3"></textarea>
            </div>
            <div>
